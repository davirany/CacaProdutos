...
export default function App() {
  const [produtosCarrinho, setProdutosCarrinho] = useState([
    { nome: "Caderno", quantidade: 2 },
    { nome: "Lápis", quantidade: 1 },
    { nome: "Mochila", quantidade: 1 },
    { nome: "Caderneta", quantidade: 1 },
  ]);

  const [produtos, setProdutos] = useState([
    { nome: "Caderno", quantidade: 7 },
    { nome: "Lápis", quantidade: 50 },
    { nome: "Mochila", quantidade: 38 },
    { nome: "Caderneta", quantidade: 38 },
  ]);
